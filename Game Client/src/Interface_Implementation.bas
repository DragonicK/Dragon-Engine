...
' Create black background
    CreateWindow "winBlank", "", zOrder_Win, 0, 0, 800, 600, 0, , , , , , DesignTypes.desWin_AincradNoBar, DesignTypes.desWin_AincradNoBar, DesignTypes.desWin_AincradNoBar, , , , , , , , , False, False
    ...
    ' Close button
    CreateButton WindowCount, "btnClose", Windows(WindowCount).Window.Width - 33, 11, 22, 22, , , , , , , Tex_GUI(TextureControl_CloseNormal), Tex_GUI(TextureControl_CloseHover), Tex_GUI(TextureControl_CloseClick), , , , , , GetAddress(AddressOf btnDialogue_Close)
    ' Parchment
...
' Create window
    ...
    CreateCheckbox WindowCount, "chkAutotiles", 35, 60, 80, , , "Autotiles", OpenSans_Regular, , , False, , DesignTypes.desChkNorm
    ...
    ' Button
    CreateButton WindowCount, "btnConfirm", 65, 168, 80, 22, "CONFIRMAR", OpenSans_Effect, , , , , , , , DesignTypes.desSteel, DesignTypes.desSteel_Hover, DesignTypes.desSteel_Click, , , GetAddress(AddressOf btnOptions_Confirm)
