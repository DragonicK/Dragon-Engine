...
Private Function GetEquipmentTypeText(ByVal EquipmentType As Byte) As String
...
Private Function GetProficiencyText(ByVal Proficiency As Byte) As String
...
Private Function GetItemSetCountText(ByVal Count As EquipmentSetCount) As String
    Select Case Count
