...
Public Sub HandlePartyInvite(ByVal Index As Long, ByRef Data() As Byte, ByVal StartAddr As Long, ByVal ExtraVar As Long)
    ...
    AddText ColourChar & GetColStr(ColorType.BrightRed) & "[Sistema] : " & ColourChar & GetColStr(White) & Trim$(TheName) & " convidou você para um grupo.", White, , ChatChannel.chGame
...
Public Sub HandleClosePartyInviation(ByVal Index As Long, ByRef Data() As Byte, ByVal StartAddr As Long, ByVal ExtraVar As Long)
    ...
    AddText ColourChar & GetColStr(ColorType.Gold) & "[Sistema] : " & ColourChar & GetColStr(Grey) & Message, Grey, , ChatChannel.chGame
End Sub
