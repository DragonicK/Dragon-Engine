...
Private Sub ButtonDelChar_1()
    If CharEnabled(1) Then
        Dialogue "Excluir Personagem", "A exclusao do personagem e permanente.", "Voce esta certo de excluir?", TypeDELCHAR, StyleYESNO, 0
    End If
End Sub

Private Sub ButtonDelChar_2()
    If CharEnabled(1) Then
        Dialogue "Excluir Personagem", "A exclusao do personagem e permanente.", "Voce esta certo de excluir?", TypeDELCHAR, StyleYESNO, 1
    End If
End Sub

Private Sub ButtonDelChar_3()
    If CharEnabled(3) Then
        Dialogue "Excluir Personagem", "A exclusao do personagem e permanente.", "Voce esta certo de excluir?", TypeDELCHAR, StyleYESNO, 2
    End If
End Sub
