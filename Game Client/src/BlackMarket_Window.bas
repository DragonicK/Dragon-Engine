...
Public Sub CreateWindow_CashShop()
    ...
    CreatePictureBox WindowCount, "picIcon2", (LeftListX + 15), (LeftListY + 60) + (ListOffsetY * 1), 32, 32, , , , , , , , DesignTypes.desTextWhite, DesignTypes.desTextWhite, DesignTypes.desTextWhite, , GetAddress(AddressOf ButtonSelectItem2_MouseMove), GetAddress(AddressOf ButtonSelectItem1_Click), GetAddress(AddressOf ButtonSelectItem2_MouseMove)
    CreatePictureBox WindowCount, "picIcon3", (LeftListX + 15), (LeftListY + 60) + (ListOffsetY * 2), 32, 32, , , , , , , , DesignTypes.desTextWhite, DesignTypes.desTextWhite, DesignTypes.desTextWhite, , GetAddress(AddressOf ButtonSelectItem3_MouseMove), GetAddress(AddressOf ButtonSelectItem1_Click), GetAddress(AddressOf ButtonSelectItem3_MouseMove)
    CreatePictureBox WindowCount, "picIcon4", (LeftListX + 15), (LeftListY + 60) + (ListOffsetY * 3), 32, 32, , , , , , , , DesignTypes.desTextWhite, DesignTypes.desTextWhite, DesignTypes.desTextWhite, , GetAddress(AddressOf ButtonSelectItem4_MouseMove), GetAddress(AddressOf ButtonSelectItem1_Click), GetAddress(AddressOf ButtonSelectItem4_MouseMove)
    CreatePictureBox WindowCount, "picIcon5", (LeftListX + 15), (LeftListY + 60) + (ListOffsetY * 4), 32, 32, , , , , , , , DesignTypes.desTextWhite, DesignTypes.desTextWhite, DesignTypes.desTextWhite, , GetAddress(AddressOf ButtonSelectItem5_MouseMove), GetAddress(AddressOf ButtonSelectItem1_Click), GetAddress(AddressOf ButtonSelectItem5_MouseMove)
    CreatePictureBox WindowCount, "picIcon6", (LeftListX + 15), (LeftListY + 60) + (ListOffsetY * 5), 32, 32, , , , , , , , DesignTypes.desTextWhite, DesignTypes.desTextWhite, DesignTypes.desTextWhite, , GetAddress(AddressOf ButtonSelectItem6_MouseMove), GetAddress(AddressOf ButtonSelectItem1_Click), GetAddress(AddressOf ButtonSelectItem6_MouseMove)
