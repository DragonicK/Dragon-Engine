...
Public Sub CreateWindow_Character()
    ...
    CreateCheckbox WindowCount, "chkView", 48, 76, 35, , False, "VISUALIZAR EQUIPAMENTO", FontRegular, ColorType.Gold, , , , DesignTypes.DesignCheckBox, , , GetAddress(AddressOf Button_ViewVisibility)
